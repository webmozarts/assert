...
class AssertTest extends BaseTestCase
{
    ...
    public function getTests()
    {
        ...
        return array(
            ...
            array('url', array('http://usern@me:password@symfony.com'), false),
            array('url', array('http://nota%hex:password@symfony.com'), false),
            array('url', array('http://username:nota%hex@symfony.com'), false),
