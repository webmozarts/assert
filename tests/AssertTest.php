...
class AssertTest extends BaseTestCase
{
    ...
    public function getTests()
    {
        ...
        return array(
            ...
            array('keyExists', array(new ArrayObject(array('key' => 0)), 'key'), true),
            array('keyExists', array(new ArrayObject(array('key' => null)), 'key'), true),
            array('keyExists', array(new ArrayObject(array('key' => null)), 'foo'), false),
            array('keyNotExists', array(new ArrayObject(array('key' => 0)), 'key'), false),
            array('keyNotExists', array(new ArrayObject(array('key' => null)), 'key'), false),
            array('keyNotExists', array(new ArrayObject(array('key' => null)), 'foo'), true),
