...
class AssertTest extends PHPUnit_Framework_TestCase
{
    ...
    public function getTests()
    {
        ...
        return array(
            ...
            array('notWhitespace', array('abc'), true),
            array('notWhitespace', array('123'), true),
            array('notWhitespace', array(' abc '), true),
            array('notWhitespace', array('a b c'), true),
            array('notWhitespace', array(''), false),
            array('notWhitespace', array(' '), false),
            array('notWhitespace', array("\t"), false),
            array('notWhitespace', array("\n"), false),
            array('notWhitespace', array("\r"), false),
            array('notWhitespace', array("\r\n\t "), false),
