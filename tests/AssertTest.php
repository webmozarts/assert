...
class AssertTest extends BaseTestCase
{
    ...
    public function getTests()
    {
        ...
        return array(
            ...
            array('contains', array(new stdClass(), '😑'), false),
            ...
            array('notContains', array(new stdClass(), '😑'), false),
            ...
            array('digits', array(new stdClass()), false),
            array('digits', array(array()), false),
            array('digits', array(50), false), // ASCII table: 2
            array('alnum', array('ab12'), true),
            array('alnum', array('ab12'), true),
            array('alnum', array('ab12$'), false),
            array('alnum', array(''), false),
            array('alnum', array(array()), false),
            array('alnum', array(new stdClass()), false),
            array('alnum', array(new ToStringClass('ab12')), false),
            array('alnum', array(50), false), // ASCII table: 2
            array('lower', array('abcd'), true),
            array('lower', array('abCd'), false),
            array('lower', array('ab_d'), false),
            array('lower', array(''), false),
            array('lower', array(array()), false),
            array('lower', array(new stdClass()), false),
            array('lower', array(new ToStringClass('lower')), false),
            array('lower', array(97), false), // ASCII table: a
            array('upper', array('ABCD'), true),
            array('upper', array('ABcD'), false),
            array('upper', array('AB_D'), false),
            array('upper', array(''), false),
            array('upper', array(array()), false),
            array('upper', array(new stdClass()), false),
            array('upper', array(new ToStringClass('UPPER')), false),
            array('upper', array(65), false), // ASCII table: A
            ...
            array('classExists', array(23), false),
            ...
            array('countBetween', array(new stdClass(), 2, 3), false),
            ...
            array('uuid', array(12), false),
            array('uuid', array(new stdClass()), false),
            ...
            array('email', array(new ToStringClass('foo@bar.com')), false),
