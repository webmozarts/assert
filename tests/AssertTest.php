...
class AssertTest extends PHPUnit_Framework_TestCase
{
    ...
    public function getTests()
    {
        ...
        return array(
            ...
            array('startsNotWith', array('abcd', 'ab'), false),
            array('startsNotWith', array('abcd', 'bc'), true),
            array('startsNotWith', array('', 'bc'), true),
            ...
            array('endsNotWith', array('abcd', 'cd'), false),
            array('endsNotWith', array('abcd', 'bc'), true),
            array('endsNotWith', array('', 'bc'), true),
