...
class AssertTest extends BaseTestCase
{
    ...
    public function getTests()
    {
        ...
        return array(
            ...
            array('url', array('http://example.com/'), true),
            array('url', array('https://example.com/'), true),
            array('url', array('https://username:password@example.com'), true),
            array('url', array('https://example.com?'), true),
            array('url', array('https://exemple.com?query=1&order[0]=name'), true),
            array('url', array('ftp://example.com'), true),
            array('url', array('faked://example.com'), true),
