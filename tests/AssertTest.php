...
class AssertTest extends TestCase
{
    ...
    public function getTests()
    {
        ...
        return array(
            ...
            array('isArrayOfType', array(array(new stdClass()), 'stdClass'), true),
            array('isArrayOfType', array(array(new stdClass()), 'object'), true),
            array('isArrayOfType', array(array('foo'), 'int'), false),
            array('isArrayOfType', array(array('foo'), 'bar'), false),
