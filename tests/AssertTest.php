...
class AssertTest extends BaseTestCase
{
    ...
    public function getTests()
    {
        ...
        return array(
            ...
            array('isAOfAny', array('ArrayIterator', array('Iterator', 'ArrayAccess')), true),
            array('isAOfAny', array('ArrayIterator', array(123)), false),
            array('isAOfAny', array('Exception', array('Exception', 'Countable')), true),
            array('isAOfAny', array('Exception', array('ArrayAccess', 'Countable')), false),
            array('isAOfAny', array(123, array('stdClass')), false),
            array('isAOfAny', array(array(), array('stdClass')), false),
            array('notAOf', array('stdClass', 'stdClass'), false),
            array('notAOf', array('stdClass', 123), false),
            array('notAOf', array('Iterator', 'ArrayIterator'), true),
            array('notAOf', array(123, 'Iterator'), true),
            array('notAOf', array(array(), 'Iterator'), true),
